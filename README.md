...
To run a scenario with multiple task requests, load `office_tasks.json` from `rmf_demo_panel/task_list` in the `Submit a list of tasks` section. This should populate the preview window with a list of tasks. Click submit and watch the demonstration unfold.
